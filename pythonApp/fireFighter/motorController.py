...
class MotorController:
    ...
    def forward(self, speed: int):
        return [['F', speed], ['F', speed], ['F', speed], ['F', speed]]

    """Moves the robot backward."""
    def backward(self, speed: int):
        return [['B', speed], ['B', speed], ['B', speed], ['B', speed]]

    def left(self, speed: int):
        return [['B', speed], ['F', speed], ['F', speed], ['B', speed]]

    def right(self, speed: int):
        return [['F', speed], ['B', speed], ['B', speed], ['F', speed]]
    ...
    def turn_manual(self, direction: str, speed: int):
        if direction == 'L':
            return [['B', speed], ['F', speed], ['B', speed], ['F', speed]]
        elif direction == 'R':
            return [['F', speed], ['B', speed], ['F', speed], ['B', speed]]
